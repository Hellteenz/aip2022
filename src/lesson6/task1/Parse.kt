...
fun dateStrToDigit(str: String): String {
    ...
    if (parts.size == 3) {
        ...
        if (day.toInt() > 31 || daysInMonth(months.indexOf(month) + 1, year.toInt()) < day.toInt()) return ""
        return String.format("%02d.%02d.%d", day.toInt(), months.indexOf(month) + 1, year.toInt())
    }
    return ""
}
